...
class Tree:
    ...
    def __init__(self, feature_names, max_depth=8):
    ...
    def generate_random_individual(self, max_depth=8, method='grow', population=20):
    ...
    def perform_crossover(self, parent1, parent2):
        ...
        self.prune_tree_max_height(offspring1.root,9)
        self.prune_tree_max_height(offspring2.root,9)
    ...
    def get_majority_class(self, node):
        # # Define a helper function to perform depth-first traversal
        # def dfs_count_labels(node):
        #     if node is None:
        #         return 0, 0  # Return counts of class labels 0 and 1 as tuple

        #     # Initialize counts for labels 0 and 1
        #     count_zero, count_one = 0, 0

        #     # Recursively traverse the left subtree
        #     left_count_zero, left_count_one = dfs_count_labels(node.left)
        #     count_zero += left_count_zero
        #     count_one += left_count_one

        #     # Recursively traverse the right subtree
        #     right_count_zero, right_count_one = dfs_count_labels(node.right)
        #     count_zero += right_count_zero
        #     count_one += right_count_one

        #     # Add the current node's class label to the counts
        #     if node.value == 0:
        #         count_zero += 1
        #     elif node.value == 1:
        #         count_one += 1
        ...
        # Randomly choose the majority class biased towards 1
        if random.random() > 0.5:  
            return 1
        else:
            return 0
